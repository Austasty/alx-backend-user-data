...
def filter_datum(fields: List[str], redaction: str,
    ...
    """
    Replaces sensitive information in a 
...
def get_logger() -> logging.Logger:
    ...
    Returns:
        A Logger object with INFO log level
...
def get_db() -> mysql.connector.connection.MySQLConnection:
    """
    Returns a MySQLConnection object for accessing Personal Data 
...
def main():
    """
    Main function to retrieve user 
    """
    db = get_db()
    cursor = db.cursor()
...
class RedactingFormatter(logging.Formatter):
    """
    Redacting Formatter class for filtering PII 
    """
